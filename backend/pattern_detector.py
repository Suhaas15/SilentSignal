...
class PatternDetector:
    ...
    def detect_patterns(self, conversation_text: str) -> Dict[str, Any]:
        """
        Detect abuse patterns in the conversation
        ...
        risk_level = self._calculate_risk_level(total_score, pattern_counts)
    ...
    def _calculate_risk_level(self, total_score: int, pattern_counts: Dict) -> str:
        """Calculate risk level based on multiple factors"""
        # Base scoring with nuanced thresholds
        if total_score >= 60:
            return "abuse"
        elif total_score >= 35:
            return "concerning"
    ...
    def get_pattern_explanations(self) -> Dict[str, str]:
        """Get explanations for different abuse patterns"""
        explanations = {}
